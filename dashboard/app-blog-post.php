...
<body class="bg-white">
    ...
    <div class="appHeader">
        <div class="left">
            <a href="app-blog-post.php#" class="headerButton goBack">
        ...
        <div class="right">
            <a href="app-blog-post.php#" class="headerButton" data-bs-toggle="modal" data-bs-target="#actionSheetShare">
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-2">
            ...
            <div class="blog-header-info mt-2 mb-2">
                <div>
                    ...
                    by <a href="app-blog-post.php#">Jack Doe</a>
                </div>
                <div>
                    24, September 2021
                </div>
        ...
        <div class="section">
            <a href="app-blog-post.php#" class="btn btn-block btn-primary" data-bs-toggle="modal" data-bs-target="#actionSheetShare">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="action-button-list">
                        <li>
                            <a href="app-blog-post.php#" class="btn btn-list" data-bs-dismiss="modal">
                                <span>
