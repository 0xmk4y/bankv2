...
<body>
    ...
    <div class="appHeader">
        <div class="left">
            <a href="app-blog.php#" class="headerButton goBack">
        ...
        <div class="right">
            <a href="app-blog.php#" class="headerButton toggle-searchbox">
    ...
    <div id="search" class="appHeader">
        <form class="search-form">
            <div class="form-group searchbox">
                ...
                <a href="app-blog.php#" class="ms-1 close toggle-searchbox"><i class="icon ion-ios-close-circle"></i></a>
            </div>
        </form>
    </div>
    <!-- * Search Component -->
    ...
    <div id="appCapsule">
        ...
        <div class="section tab-content mt-2 mb-2">
            ...
            <div>
                <a href="app-blog.php#" class="btn btn-block btn-primary btn-lg">Load More</a>
            </div>
