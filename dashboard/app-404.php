...
<body class="bg-white">
    ...
    <div class="appHeader no-border">
        <div class="left">
            <a href="app-404.php#" class="headerButton goBack">
    ...
    <div id="appCapsule">
        ...
        <div class="fixed-bar">
            <div class="row">
                <div class="col-6">
                    <a href="app-404.php#" class="btn btn-lg btn-outline-secondary btn-block goBack">Go Back</a>
                </div>
                <div class="col-6">
                    <a href="app-pages.php" class="btn btn-lg btn-primary btn-block">Try Again</a>
                </div>
            </div>
        </div>
