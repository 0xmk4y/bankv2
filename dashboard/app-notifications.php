...
<body class="bg-white">
    ...
    <div class="appHeader">
        <div class="left">
            <a href="app-notifications.php#" class="headerButton goBack">
        ...
        <div class="right">
            <a href="app-notifications.php#" class="headerButton" onclick="toastbox('toast-example-1', 3000)">
    ...
    <!-- toast bottom iconed -->
    <div id="toast-example-1" class="toast-box toast-bottom " style="background-color: #026597;">
        <div class="in">
            <ion-icon name="notifications-off-outline"></ion-icon>
            <div class="text">
