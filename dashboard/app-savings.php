...
<body>
    ...
    <div class="appHeader">
        <div class="left">
            <a href="app-savings.php#" class="headerButton goBack">
        ...
        <div class="right">
            <!-- <a href="app-savings.php#" class="headerButton" data-bs-toggle="modal" data-bs-target="#actionSheetForm">
                        ...
                        <form>
                            ...
                            <div class="form-group basic">
                                <button type="button" class="btn btn-primary btn-block btn-lg"
                                    data-bs-dismiss="modal">Add Goal</button>
                            </div>
                        </form>
