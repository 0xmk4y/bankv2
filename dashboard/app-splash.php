...
<body class="bg-white">
    ...
    <div class="appHeader no-border">
        <div class="left">
            <a href="app-splash.php#" class="headerButton goBack">
    ...
    <div id="appCapsule">
        ...
        <div class="section">
            <div class="splash-page mt-5 mb-5">
                ...
                <h2 class="mb-2">Touch ID Require!</h2>
                <p>
        ...
        <div class="fixed-bar">
            <div class="row">
                <div class="col-6">
                    <a href="app-pages.php" class="btn btn-lg btn-outline-secondary btn-block">Cancel</a>
                </div>
                <div class="col-6">
                    <a href="app-pages.php" class="btn btn-lg btn-primary btn-block">Use Touch ID</a>
                </div>
            </div>
        </div>
