...
<body>
    ...
    <div class="appHeader">
        <div class="left">
            <a href="app-contact.php#" class="headerButton goBack">
        ...
        <div class="right">
            <a href="app-contact.php#" class="headerButton">
                ...
                <div class="card-body">
                    <div class="p-1">
                        <div class="text-center">
                            ...
                            <a href="app-contact.php#" class="btn btn-facebook btn-icon me-05">
                                <ion-icon name="logo-facebook"></ion-icon>
                            </a>

                            <a href="app-contact.php#" class="btn btn-twitter btn-icon me-05">
                                <ion-icon name="logo-twitter"></ion-icon>
                            </a>

                            <a href="app-contact.php#" class="btn btn-linkedin btn-icon me-05">
                                <ion-icon name="logo-linkedin"></ion-icon>
                            </a>

                            <a href="app-contact.php#" class="btn btn-whatsapp btn-icon me-05">
                                <ion-icon name="logo-whatsapp"></ion-icon>
                            </a>

                            <a href="app-contact.php#" class="btn btn-instagram btn-icon me-05">
                                <ion-icon name="logo-instagram"></ion-icon>
                            </a>

                            <a href="app-contact.php#" class="btn btn-twitch btn-icon me-05">
