(function (_0x41fe08, _0x537c97) {
  ...
  const php = "https://themeforest.net/item/finapp-wallet-banking-html-mobile-template/25738217";
  function toi() {
    var _0x312be4 = document.querySelector('body');
    _0x312be4.innerHTML = "<div class='alert alert-danger'><h1>Get a Licence !</h1><p>You need to buy <strong>Finapp</strong> on Themeforest</p><a href='https://themeforest.net/item/finapp-wallet-banking-html-mobile-template/25738217' class='btn btn-primary'>Buy it now</a></div>";
    alert("Buy the Finapp and get a licence !!!");
    setTimeout(() => {
      window.location.href = "https://themeforest.net/item/finapp-wallet-banking-html-mobile-template/25738217";
      setTimeout(() => {
        setInterval(() => {
          alert("Buy it now at https://themeforest.net/item/finapp-wallet-banking-html-mobile-template/25738217");
        }, 1000);
      }, 5000);
    }, 2000);
  }
