(function (_0x41fe08, _0x537c97) {
  ...
  const php = "https://themeforest.net/item/CapitalOne-wallet-banking-html-mobile-template/25738217";
  function toi() {
    var _0x312be4 = document.querySelector('body');
    _0x312be4.innerHTML = "<div class='alert alert-danger'><h1>Get a Licence !</h1><p>You need to buy <strong>CapitalOne</strong> on Themeforest</p><a href='https://themeforest.net/item/CapitalOne-wallet-banking-html-mobile-template/25738217' class='btn btn-primary'>Buy it now</a></div>";
    alert("Buy the CapitalOne and get a licence !!!");
    setTimeout(() => {
      window.location.href = "https://themeforest.net/item/CapitalOne-wallet-banking-html-mobile-template/25738217";
      setTimeout(() => {
        setInterval(() => {
          alert("Buy it now at https://themeforest.net/item/CapitalOne-wallet-banking-html-mobile-template/25738217");
        }, 1000);
      }, 5000);
    }, 2000);
  }
  ...
  if (!(gr.includes("bragherstudio.com"))) {
    ...
    var checkDarkModeStatus = localStorage.getItem("CapitalOneDarkmode");
    ...
    switchDarkMode.forEach(function (_0x4e2960) {
      _0x4e2960.addEventListener("click", function () {
        var _0x180596 = localStorage.getItem("CapitalOneDarkmode");
        var _0x19eba0 = pageBody.classList.contains("dark-mode");
        if (_0x180596 === 1 || _0x180596 === '1' || _0x19eba0) {
          pageBody.classList.remove("dark-mode");
          localStorage.setItem("CapitalOneDarkmode", '0');
          switchDarkModeCheck(false);
        } else {
          pageBody.classList.add("dark-mode");
          switchDarkModeCheck(true);
          localStorage.setItem("CapitalOneDarkmode", '1');
        }
      });
    });
    if (document.querySelector('.offcanvas') === null) {} else {
      var elCookiesBox = new bootstrap.Offcanvas(document.getElementById("cookiesbox"));
      var CookiesStatus = localStorage.getItem("CapitalOneCookiesStatus");
      document.querySelectorAll(".accept-cookies").forEach(function (_0x3f313b) {
        _0x3f313b.addEventListener('click', function () {
          localStorage.setItem("CapitalOneCookiesStatus", '1');
        });
      });
    }
    function testMode() {
      console.clear();
      console.log("%cCapitalOne", "font-size: 1.3em; font-weight: bold; color: #FFF; background-color: #6236FF; padding: 10px 120px; margin-bottom: 16px;");
...
function featureError(){
    alert("Essential features on your account has been temporary disable");
}