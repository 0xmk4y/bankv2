...
<body>
    ...
    <div class="appHeader">
        <div class="left">
            <a href="app-bills.php#" class="headerButton goBack">
        ...
        <div class="right">
            <a href="app-bills.php#" class="headerButton" data-bs-toggle="modal" data-bs-target="#actionSheetForm">
    ...
    <div class="extraHeader pe-0 ps-0">
        <ul class="nav nav-tabs lined" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="app-bills.php#waiting" role="tab">
                    Waiting
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="app-bills.php#paid" role="tab">
                    Paid
                </a>
            </li>
        </ul>
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <div class="bill-box">
                            ...
                            <a href="app-bills.php#" class="btn btn-primary btn-block btn-sm">PAY NOW</a>
                        </div>
                    </div>
                    <div class="col-6 mb-2">
                        <div class="bill-box">
                ...
                <div class="row">
                    <div class="col-6 mb-2">
                        <div class="bill-box">
                            ...
                            <div class="price">$ 14</div>
                            <p>Prime Monthly Subscription</p>
                            <a href="app-bills.php#" class="btn btn-primary btn-block btn-sm">DETAIL</a>
                        </div>
                    </div>
                </div>
            </div>
