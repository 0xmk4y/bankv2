...
<body class="bg-white">
    ...
    <div class="appHeader no-border">
        <div class="left">
            <a href="app-qr-code.php#" class="headerButton goBack">
        ...
        <div class="right">
            <a href="app-qr-code.php#" class="headerButton" data-bs-toggle="modal" data-bs-target="#DialogBasic">Help</a>
        </div>
    </div>
    <!-- * App Header -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="btn-inline">
                        <a href="app-qr-code.php#" class="btn btn-text-primary" data-bs-dismiss="modal">OK</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="appCapsule">
        ...
        <div class="fixed-bar">
            <div class="row">
                <div class="col-12">
                    <a href="app-pages.php" class="btn btn-lg btn-outline-secondary btn-block">Go Back</a>
                </div>
            </div>
        </div>
